    ...
    return declare("bgagame.threespot", ebg.core.gamegui, {
        ...
        */
        ...
        setup: function( gamedatas )
        {
            ...
            this.playerHand.image_items_per_row = 8; // 13 images per row
            ...
            // add the 3 of spades and 5 of hearts to the player hand
            this.playerHand.addToStockWithId( this.getCardUniqueId( 1, 7 ), 37 );
            this.playerHand.addToStockWithId( this.getCardUniqueId( 2, 7 ), 44 );
